...
class ScanNetDataset(object):
    def __init__(self, cvfold, data_path, bg_data_path=None):
        ...
        self.fold_0 = ['sink', 'toilet', 'bathtub', 'shower curtain', 'picture', 'counter']  # last 6 as novel class [9, 11, 10, 16, 18, 13]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--bg_data_path', type=str, default='pt_pcd_camz01')
